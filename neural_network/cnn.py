...
# -*- coding: utf-8 -*-
"""
Created on Sat Jun  1 10:28:30 2019
...
train = dataset["2018-08-21":"2018-08-23"]['close_escalado']
test = dataset["2018-08-24"]['close_escalado']
...
def get_model():
    ...
    model.add(layers.Conv1D(filters=128, kernel_size=1, activation='relu', input_shape=(X_train.shape[1],X_train.shape[2])))
